class DeliverablesController < ApplicationController
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to deliverables_path, status: :see_other, notice: "Deliverable was successfully destroyed." }
  ...
  private
    ...
    def set_deliverable
      @deliverable = Deliverable.find(params.expect(:id))
    end

    # Only allow a list of trusted parameters through.
    def deliverable_params
      params.expect(deliverable: [ :contract_id, :trade_symbol, :destination_symbol, :units_required, :units_fulfilled ])
    end
end
